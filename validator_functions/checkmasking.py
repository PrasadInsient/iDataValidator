...
def checkmasking(questionid,datarow:pd.Series,question_cols: List[str], maskcond_cols: List[str], maskcondition: str ="=1",  always_showcols: List[str]=[], condition= True):
