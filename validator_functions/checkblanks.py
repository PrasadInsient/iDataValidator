...
def checkblanks(questionid: str, datacols: list, datarow: pd.Series, exclude_cols: list = [], condition: bool = True):
    """
    ...
    Parameters:
        ...
        exclude_cols (list, optional): A list of columns that should be excluded from the blank check. These columns will be removed from `datacols` before the check is performed. Defaults to an empty list.
    ...
    Example Usage:
        ...
        checkblanks('Q1', datacols, datarow, exclude_cols)
